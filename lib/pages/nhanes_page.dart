...
class _NhpPageState extends State<NhpPage> {
  ...
  final sexIdx = ValueNotifier<int>(0);                   // RIAGENDR: 1=Male, 2=Female
        ...
        Row(children: [
          ...
          Expanded(child: ValueListenableBuilder<bool>(
            ...
            builder: (_, v, __) => SwitchListTile(
              ...
              value: v, onChanged: (x) => smoker.value = x,
            ),
          )),
        ]),
  ...
  Widget _result(Map<String, dynamic> r) {
    ...
    final shap = (r["shap_top"] as Map?)?.cast<String, dynamic>();
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text("Risk: ${(p * 100).toStringAsFixed(1)}%"),
        Text("Category: $cat"),
        const SizedBox(height: 8),
        if (shap != null) ...[
